...
class TableManager {
  ...
  async pCreateTicketsCarousel (tickets = [
    ...
    btnPrev.setAttribute('class', 'btn myButtons btnPrev m-2 bounce-in-top hideElement')
  ...
  ///hide / show buttons when thev minimum or maximum value has been reached
    ...
    function btnHideMgr(evt, scrollIndex, max){
      ...
      if (scrollIndex == max) {
        parent.querySelector(".btnNext").classList.add('hideElement') //btnPrev
      } else {
        parent.querySelector(".btnNext").classList.remove('hideElement');
      }
      if (scrollIndex == 0) {
        parent.querySelector(".btnPrev").classList.add('hideElement') 
      } else {
        parent.querySelector(".btnPrev").classList.remove('hideElement');
      }
    }

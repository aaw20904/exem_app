...
CREATE TABLE `exemtime` (
  ...
  KEY `fk_exemtime_idx` (`usrId`),
  CONSTRAINT `fk_exemtime` FOREIGN KEY (`usrId`) REFERENCES `users` (`usrId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `exemtime` VALUES (-1125217597,'2022-07-08 12:01:33');
...
CREATE TABLE `names` (
  ...
  `usrId` int NOT NULL,
  PRIMARY KEY (`name`),
  KEY `fk_names_idx` (`usrId`),
  CONSTRAINT `fk_names` FOREIGN KEY (`usrId`) REFERENCES `users` (`usrId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `names` VALUES ('administrator',-1125217597);
...
INSERT INTO `users` VALUES (-1125217597,_binary '$2b$10$.Ju8486sBZIBNcWZ1jVHmO2cTmZTbBHYTMII.ihqWI7cfdRqe5sB6',-1,0);
...
-- Dump completed on 2022-07-08 12:03:10
